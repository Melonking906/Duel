...
public class Config extends AutoUpdateConfigLoader
{
    ...
    public boolean getConfigOverwriteEnabled()
    {
    ...
    public int getDuelLength()
    {
        return config.getInt( "Duel.Duel_Length", 120 );
    }

    public int getMessageRange()
    {
        return config.getInt( "Duel.Message_Range", 50 );
    }

    public boolean getHealEnabled()
    {
        return config.getBoolean( "Duel.Heal_After_Duel", true );
    }

    public List<String> getPotionEffectsToRemove()
    {
        return config.getStringList( "Duel.Potion_Effects_To_Remove" );
    }

    public List<String> getBlockedCommands()
    {
        return config.getStringList( "Duel.Blocked_Commands" );
    }

    public boolean getCallDeathEvents()
    {
        return config.getBoolean( "Duel.Call_DeathEvents", false );
    }

    /* ARENA SETTINGS */
    public boolean getBorderKnockBack()
    {
        return config.getBoolean( "Arena.Knockback_Enabled", true );
    }

    public double getArenaSize()
    {
        return config.getDouble( "Arena.Radius", 20.0 );
    }

    public boolean getBorderParticleEffectsEnabled()
    {
        return false;
    }

    /* CHALLENGE SETTINGS */
    public boolean getChallengeCommandsEnabled()
    {
        return config.getBoolean( "Challenge.Enable_Challenge_Commands", false );
    }

    public InteractType getChallengeInteractType()
    {
        return InteractType.getInteractType( config.getString( "Challenge.Challenge_Interact" ) );
    }

    public boolean getChallengeHoldShift()
    {
        return config.getBoolean( "Challenge.Challenge_Hold_Shift", true );
    }

    public int getInviteTimeout()
    {
        return config.getInt( "Challenge.Timeout", 20 );
    }
    ...
    /* WORLDGUARD SETTINGS */
    public boolean getWGUseAsWhitelist()
    {
    ...
    {
        return config.getStringList( "WorldGuard.Regions" );
    }

    /* WORLD SETTINGS */
    public boolean getWorldUseAsWhitelist()
    {
        return config.getBoolean( "Worlds.Use_As_Whitelist", false );
    }
